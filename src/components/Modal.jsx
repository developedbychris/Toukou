...
//! TODO: 
// ON COUNT CHANGE, 2 BUTTON POPS UP BELOW EPISODE COUNT TO COMMIT CHANGES.
// 1 BUTTON WILL COMMIT CHANGES NO TWEETS AND 1 BUTTON WILL COMMIT CHANGES AND TWEET UPDATE.
...
const Modal = ({ modalMedia, closeModal }) => {
  ...
  return (
    <div className={`${modalCSS} overflow-x-hidden`}>
      ...
      <div className="modal-content px-10 py-5  w-11/12 md:w-11/12 lg:w-10/12 xl:w-6/12 rounded-xl mx-auto mt-10 border-b-2 border-l-2" style={{borderColor: modalMedia.media.coverImage.color}}>
